...
* Do you think it would be easier or harder to search through this data manually or using SQL? Harder manually.
* What about when the dataset gets larger? Harder manually.
